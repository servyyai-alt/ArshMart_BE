...
export const createShiprocketOrder = async (order) => {
  ...
  if (!billingEmail) billingEmail = process.env.ADMIN_EMAIL || 'support@arshmart.com'
...
export const createShiprocketReturnOrder = async ({ order, returnRequest, items }) => {
  ...
  const payload = {
    ...
    pickup_email: order.user?.email || process.env.ADMIN_EMAIL || 'support@arshmart.com',
    pickup_phone: pickupPhone,
    shipping_customer_name: warehouse.name || 'Arsh Mart Warehouse',
    shipping_last_name: '',
